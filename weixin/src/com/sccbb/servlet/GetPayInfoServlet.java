...
public class GetPayInfoServlet extends HttpServlet {
				...
				throws ServletException, IOException {
				        ...
				        try{
				        	...
				        	String ordernumber = ordernumber();//生成订单号
...
//				        	session.setAttribute("money", fee);//保存实际支付金额，单位为分
				...
				public static String ordernumber(){
					SimpleDateFormat df=new SimpleDateFormat("yyyyMMddhhmmssSSS");//当前时间精确到时分秒
			        String ordernumber = "smy"+df.format(new Date()).toString().substring(2,16);
					return ordernumber;
				}
				...
				public String getSign (Map<String,String> data) throws Exception{
					...
					String key ="s1LJrq1rCAI7APV3ZZfUlj1SLEoFjtiQ";
